...
当前进入第 5 轮分域迁移：Home → Search → Cart、商品、认证，以及订单 / 物流 / 申诉已经可运行；路由矩阵当前为 29 migrated / 27 pending。活进度见 [docs/06-current-progress.md](./docs/06-current-progress.md)，路线和学习材料见 [docs/README.md](./docs/README.md)。
